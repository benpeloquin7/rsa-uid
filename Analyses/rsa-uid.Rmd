...
* `Simulation 2` indicates that we might be able to model syntactic UID in some scenarios, perhaps meaningful disfluencies as well. Can estimate some of the hyperparameters from text? (Her Clark's um paper)
