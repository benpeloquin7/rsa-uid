...
modelFile <- getModelFile(file.path('Models', 'um-implicature-model-20171215.wppl'))
```
...
```{r um-implicature-run, echo=FALSE}
...
Note this the basic direction of the effect as documented in Levy & Jaeger (2007) Fig1.
