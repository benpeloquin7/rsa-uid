...
plot3ModelFile <- "/Users/benpeloquin/Desktop/Projects/rsa_uid/Models/fyp-presentation/noisy-rsa-corpus-model.wppl"
```
...
df_nrsa_corpus <- corpus_run_fn(plot3ModelFile, "S3", ALPHA, LAMBDA, THETA, nUtterances, nSims) %>%
...
# 
# df_plot3 <- corpus_run_fn(plot3ModelFile, 'S3', ALPHA, LAMBDA, THETA, nUtterances)
```

```{r plot3-rsa-uid-corpus-analysis}
df_nrsa_corpus %>%
